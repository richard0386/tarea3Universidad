    ...
    public partial class autoform : Form
    {
        ...
        public void crearauto()
        {
            ...
            try
            {
                ...
                //Se crea un objeto de la clase automóvil 
                automovil at = new automovil(textBox1.Text.Trim(), textBox2.Text.Trim(), textBox3.Text.Trim(), textBox6.Text.Trim(), textBox7.Text.Trim(), "automovil", comboBox1.Text);

                using (var ent = new tarea3Entities2())
                {
                    IQueryable<Auto> autosquery = from Auto in ent.Autos //IQueryable<Auto> sirve para hacer una consulta a la base de datos
                                                                             //y devuelve una lista de todos los registros en este caso la tabla Auto
                                                  select Auto;

                    foreach(Auto ahu in autosquery)
                    {
                        if (ahu.Placa==textBox1.Text.Trim())
                        {
                            existe = true;
                            //Se recorre el objeto autosquery para validar si la placa en el cuadro de texto de placa ya existe
        ...
        private void autoform_Load(object sender, EventArgs e)
        {
            ...
            //Selecciona la posición 0 en el combobox 
        }
